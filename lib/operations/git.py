...
command into a loaded submodule verbatim."""
...
class GitOperation(RepoOperation):
    ...
    git command to a loaded submodule: everything after <name> runs verbatim
    as `git -C hf/<ns>/<entity>/<name> <git args...>`, and the exit code is
